HOW TO INSTALL
This only includes the b2evolution-specific parts of Bad Behavior.  For it to
actually work, you'll have to to get the Bad Behavior files from elsewhere
[1].  That includes copying the bad-behavior directory and the
bad-behavior-mysql.php files into this directory.
